...
import io.jmix.ui.persistence.JmixUiPersistenceConfiguration;
...
@JmixModule(dependsOn = JmixUiPersistenceConfiguration.class)
public class JmixUiPersistenceTestConfiguration {
