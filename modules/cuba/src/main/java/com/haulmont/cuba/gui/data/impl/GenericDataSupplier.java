...
public class GenericDataSupplier implements DataSupplier {
    ...
    @Override
    public <T extends Entity<K>, K> void remove(Id<T> entityId) {
    ...
    @Override
    public <E extends Entity<K>, K> FluentLoader<E> load(Class<E> entityClass) {
        return getDataManager().load(entityClass);
    }

    @Override
    public <E extends Entity<K>, K> FluentLoader.ById<E> load(Id<E> entityId) {
    ...
    @Override
    public <T extends Entity<K>, K> T getReference(Id<T> entityId) {
        return null;
    }
