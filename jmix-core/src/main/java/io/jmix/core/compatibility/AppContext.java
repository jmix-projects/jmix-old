...
import io.jmix.core.impl.SecurityContextHolder;
import io.jmix.core.impl.ThreadLocalSecurityContextHolder;
...
//        }
        ...
        public static void setApplicationContext(@Nullable ApplicationContext applicationContext) {
            ...
            AppContext.appProperties = applicationContext != null ?
