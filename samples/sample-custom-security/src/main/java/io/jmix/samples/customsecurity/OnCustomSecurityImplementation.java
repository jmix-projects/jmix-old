 ...
 * for registration when "custom" security implementation is selected.
 */
public class OnCustomSecurityImplementation extends AbstractSecurityImplementationCondition {
